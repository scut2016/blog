...
?>
		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="<?=\yii\helpers\Url::toRoute('category/list')?>" target="main"><i class="fa fa-fw fa-list-ul"></i>列表页</a></li>
	...
	<!--主体部分 开始-->
	<div class="main_box">
		<iframe src="<?=\yii\helpers\Url::toRoute('admin/info')?>" frameborder="0" width="100%" height="100%" name="main"></iframe>
	</div>
	<!--主体部分 结束-->
